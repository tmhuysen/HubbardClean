...
TEST(io_degen, test){
    ...
    std::string fileout = "/Users/wulfix/Desktop/Cursussen_Gent/Thesis/Hubbards_Qmark/HubbardClean/unit_tests/basic_tests/input_data/degenerateLattice.txt";
